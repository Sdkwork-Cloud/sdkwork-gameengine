...
pub struct GamesProblemCorrelation {
    pub request_id: String,
    pub trace_id: Option<String>,
}

tokio::task_local! {
    static CURRENT_PROBLEM_CORRELATION: GamesProblemCorrelation;
}
...
pub async fn problem_correlation_middleware(request: Request, next: Next) -> Response {
    let correlation = GamesProblemCorrelation::from_request(&request);
