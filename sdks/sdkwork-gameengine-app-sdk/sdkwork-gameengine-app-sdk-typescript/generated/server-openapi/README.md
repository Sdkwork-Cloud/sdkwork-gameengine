...
- `client.leaderboard` - leaderboard API
...
```typescript
// GET /app/v3/api/games/leaderboard/me
const params = {
  game_id: 'game_id',
};
const result = await client.leaderboard.games.leaderboard.me.retrieve(params);
```

### rooms

```typescript
// GET /app/v3/api/games/rooms
const params = {
  game_id: 'game_id',
  status: 'open',
  page: 3,
...
const result = await client.rooms.games.rooms.list(params);
```
