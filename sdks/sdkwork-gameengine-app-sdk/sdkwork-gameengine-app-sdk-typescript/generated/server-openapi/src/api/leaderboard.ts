...
export interface LeaderboardGamesLeaderboardMeRetrieveParams {
  gameId?: string;
}

export class LeaderboardGamesLeaderboardMeApi {
...
export interface LeaderboardGamesLeaderboardListParams {
  gameId?: string;
  page?: number;
  pageSize?: number;
}

export class LeaderboardGamesLeaderboardApi {
  private client: HttpClient;
  public readonly me: LeaderboardGamesLeaderboardMeApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.me = new LeaderboardGamesLeaderboardMeApi(client);
  }
...
export function createLeaderboardApi(client: HttpClient): LeaderboardApi {
  return new LeaderboardApi(client);
}
