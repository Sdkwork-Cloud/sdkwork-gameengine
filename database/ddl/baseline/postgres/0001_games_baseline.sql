-- SDKWork game engine consolidated initialization baseline (postgres)
...
-- baseline source: ddl/baseline/postgres/0001_games_baseline.sql
...
CREATE TABLE IF NOT EXISTS game_catalog (
  ...
  summary TEXT,
  genre TEXT,
  cover_media JSONB NOT NULL DEFAULT '{}'::jsonb,
...
CREATE TABLE IF NOT EXISTS game_mode (
  ...
  team_size INTEGER,
  ruleset_id TEXT,
  matchmaking_enabled BOOLEAN NOT NULL DEFAULT FALSE,
