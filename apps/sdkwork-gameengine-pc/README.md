...
- `packages/sdkwork-gameengine-pc-core` —shared runtime (stores, SDK wiring)
- `packages/sdkwork-gameengine-pc-commons` —shared UI components and hooks
- `packages/sdkwork-gameengine-pc-<capability>` —user-facing capability modules
